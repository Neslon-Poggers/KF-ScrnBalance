...
defaultproperties
{
    ...
    KFHints[ 0]="ScrN: You can interrupt reloading by dropping the weapon you're holding."
    KFHints[ 1]="ScrN: Many weapons have a tactical reload property, which allows them to reload faster if they're not empty."
    KFHints[ 2]="ScrN: You can reload the Boomstick with a single shell inside it."
    KFHints[ 3]="ScrN: The Combat Shotgun performs far better. Give it a try."
    KFHints[ 4]="ScrN: All shotguns, except the Combat Shotgun and the Boomstick penetrate fat bodies worse than they do small enemies."
    KFHints[ 5]="ScrN: The M99 cannot stun Scrakes with body-shots."
    KFHints[ 6]="ScrN: The M14EBR has different options for laser sight colors."
    KFHints[ 7]="ScrN: Hand grenades can now be 'cooked'. This can be enabled/disabled with an optional feature in the 'ScrN Features' menu."
    KFHints[ 8]="ScrN: Gunslingers have bonuses both for single and dual pistols. But real Cowboys use only dualies."
    KFHints[ 9]="ScrN: Equipping dual pistols with the Gunslinger perk equipped grants you Cowboy mode, which increases your firerate and movespeed." 
    KFHints[10]="ScrN: The Berserker moves slower than other perks if they do not have a melee weapon equipped."
    KFHints[11]="ScrN: The Chainsaw deals more damage but consumes fuel and features an alternate attack that stuns Scrakes."
    KFHints[12]="ScrN: Support Specialists are able to use the Chainsaw. Remember The Evil Dead? Try the Chainsaw + Boomstick loadout."
    KFHints[13]="ScrN: Medics have regular frag nades. Don't blow yourself up now!"
    KFHints[14]="ScrN: Medics have the same move speed as the knife when holding a syringe."
    KFHints[15]="ScrN: Medics heal much faster than other perks. If you aren't a Medic, don't screw up the healing process with your lame injection."
    KFHints[16]="ScrN: Medics get XP for shooting zeds with Medic Guns. Don't forget to heal your teammates!"
    KFHints[17]="ScrN: Medic nades are for healing only. Zeds no longer take damage from them or avoid them."
    KFHints[18]="ScrN: The Combat Medic is more 'combat' than 'Medic'"
    KFHints[19]="ScrN: The FN-FAL has armor-piercing bullets and a 2-round fixed burst mode."
    KFHints[20]="ScrN: The MK23 lacks bullet penetration but has double the size of the .44 Magnum's magazine."
    KFHints[21]="ScrN: Your experience and perk bonus levels may be different. If they are, you'll see two perk icons on the HUD."
    KFHints[22]="ScrN: If you see two perk icons on the HUD, the left one shows your experience level while the right is actual level of perk bonuses that you gain."
    KFHints[23]="ScrN: The Husk Gun's secondary fire acts as a Napalm Thrower."
    ...
    KFHints[25]="ScrN: The Nailgun can now nail enemies to walls... nail them alive! Crucify your ZED!"
    KFHints[26]="ScrN Console Command: MVOTE - access to ScrN Voting. Type MVOTE HELP for more info."
    KFHints[27]="Social Isolation: The Virus gets spread by close contact. Keep your distance!"
    KFHints[28]="Social Isolation: Infected players should keep their distance from other infected as well. An increased Virus concentration in the air leads to severe symptoms."
    KFHints[29]="Social Isolation: Epidemic safety rules prohibit picking up the items of infected players, even if you are already infected."
    ...
    KFHints[32]="Social Isolation: 'I can feel it coming in the air tonight, oh Lord!' Yes, that's the Virus in the air. And it's gonna KILL you!"
    KFHints[33]="Social Isolation: The shop is a high-risk area for spreading the Virus. Keep your distance and wait in line to shop."
}
